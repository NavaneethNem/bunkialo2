...
- `app/build.gradle.kts` defines the `com.codialo.Bunkialo2` application ID and its release signing requirements. The Kotlin namespace remains `com.codialo.bunkialo`.
...
- Both scripts intentionally use the package ID `com.codialo.Bunkialo2` and never hardcode a watch IP address or serial.
